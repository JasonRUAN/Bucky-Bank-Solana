...
import BuckyBankIDL from "../../../anchor/target/idl/bucky_bank.json";
import type { BuckyBank } from "../../../anchor/target/types/bucky_bank";
    ...
    switch (cluster) {
        ...
        case "testnet":
            ...
            return new PublicKey(
                "2N4emW88bMtPELSz6s62oTt48enm2yo8KbSdk9BeGPBG"
            );
        case "mainnet-beta":
        default:
